...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/conciertos.css') }}">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
</head>
<body>
    <header>
        <h1>Eventos de Conciertos</h1>
        <nav>
    ...
    <div class="filtros">
        ...
        <div class="filtro-activo">
            Conciertos <a href="{{ route('categorias.conciertos.remover') }}">X</a>
        </div>
    </div>

    <div class="lista-de-eventos">
        @forelse ($conciertos as $evento)
            <div class="evento">
                <h3>{{ $evento->nombre }}</h3>
        ...
        @empty
            <p>No hay eventos disponibles conciertos.</p>
        @endforelse
        <div class="paginacion">{{ $conciertos->links() }}</div>
    </div>
    ...
    <footer>
        <div class="footer-container">
            <div class="footer-section">
                ...
                <p>Explora los mejores conciertos y eventos musicales en nuestra plataforma. ¡Vive la música!</p>
            </div>
            <div class="footer-section">
                <h4>Enlaces Rápidos</h4>
                <ul>
                    <li><a href="{{ route('bienvenida') }}">Todos los eventos</a></li>
                    <li><a href="{{ route('categorias.festival') }}">Festivales</a></li>
            ...
            <div class="footer-section">
                <h4>Contacto</h4>
                <ul>
                    <li>Email: info@conciertos.com</li>
        ...
        <div class="copyright">
            © {{ date('Y') }} Plataforma de Conciertos. Todos los derechos reservados.
        </div>
    </footer>
</body>
</html>