...
<body class="principal">
        ...
        <div class="barra">
            <nav>
                <div class="menu-ciudades" id="botonCiudades">
                    ...
                    <div id="menuCiudades" class="contenido-ciudades oculto"></div>
                </div>
                <div class="divisor">
    ...
    <div class="fondo">
        <center>
            <h2 class="titulo-destacados">Resultados para "{{ $query ?? $ciudad ?? 'Todos los eventos' }}"</h2>
        </center>
        <div class="contenedor-destacados">
            ...
            @empty
                <p style="text-align: center;">No se encontraron eventos para "{{ $query ?? $ciudad ?? 'la búsqueda' }}".</p>
            @endforelse
        </div>
        <center>
            <a href="{{ url('/') }}" class="texto-regresar">← Volver al inicio</a>
        </center>
    </div>
